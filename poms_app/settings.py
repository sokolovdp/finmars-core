...
REDIS_IGNORE_EXCEPTIONS = ENV_BOOL("REDIS_IGNORE_EXCEPTIONS", default=True)
REDIS_SOCKET_CONNECT_TIMEOUT = ENV_INT("REDIS_SOCKET_CONNECT_TIMEOUT", default=1)
REDIS_SOCKET_TIMEOUT = ENV_INT("REDIS_SOCKET_TIMEOUT", default=1)
