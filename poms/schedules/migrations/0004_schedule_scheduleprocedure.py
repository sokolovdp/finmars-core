    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cron_expr', models.CharField(blank=True, default='',
                                               ...
                                               max_length=255, validators=[poms.schedules.models.validate_crontab],
                ...
                ('next_run_at',
                 models.DateTimeField(db_index=True, default=django.utils.timezone.now, verbose_name='next run at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_code', models.CharField(blank=True, max_length=25, null=True, verbose_name='user code')),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='procedures',
                                               to='schedules.Schedule', verbose_name='schedule')),
            ],
        ),
    ]
