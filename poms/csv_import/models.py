...
class CsvImportScheme(NamedModel, TimeStampedModel, ConfigurationModel, FakeDeletableModel):
    ...
    instrument_reference_column = models.CharField(
        max_length=255,
        default="",
        blank=True,
        null=True,
    ...
    column_matcher = models.CharField(
        max_length=255,
        choices=COLUMN_MATCHER_CHOICES,
        default="index",
    )
    ...
    item_post_process_script = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        default="",
...
class EntityField(models.Model):
    ...
    use_default = models.BooleanField(
        default=True,
        verbose_name=gettext_lazy("use default"),
    )
    order = models.IntegerField(
        default=0,
        verbose_name=gettext_lazy("order"),
    )
    system_property_key = models.CharField(
        max_length=255,
        null=True,
    )
    attribute_user_code = models.CharField(
        max_length=255,
        null=True,
    )
    scheme = models.ForeignKey(
...
class SimpleImportProcessItem(object):
    ...
    def __str__(self):
        return f"Row number {self.row_number}"
