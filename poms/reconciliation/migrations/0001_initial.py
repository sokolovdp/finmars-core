    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_canceled', models.BooleanField(db_index=True, default=False, verbose_name='is canceled')),
                ('status',
                 models.PositiveSmallIntegerField(choices=[(1, 'Matched'), (2, 'Unmatched')], db_index=True, default=2,
                                                  verbose_name='status')),
                ('match_date', models.DateField(blank=True, db_index=True, null=True, verbose_name='value date')),
                ('notes', models.TextField(blank=True, null=True, verbose_name='notes')),
                ('complex_transaction',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transactions.ComplexTransaction',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_date', models.DateField(blank=True, db_index=True, null=True, verbose_name='value date')),
                ('is_canceled', models.BooleanField(db_index=True, default=False, verbose_name='is canceled')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Matched'), (2, 'Conflict'), (2, 'Resolved')],
