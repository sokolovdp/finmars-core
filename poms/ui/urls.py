...
router.register(r'portal-interface-access', ui.PortalInterfaceAccessViewSet)
router.register(r'list-layout', ui.ListLayoutViewSet)
...
router.register(r'draft', ui.DraftViewSet)
...
router.register(r'complex-transaction-user-field', ui.ComplexTransactionUserFieldViewSet)
router.register(r'transaction-user-field', ui.TransactionUserFieldViewSet)
router.register(r'instrument-user-field', ui.InstrumentUserFieldViewSet)
router.register(r'entity-tooltip', ui.EntityTooltipViewSet)
router.register(r'context-menu-layout', ui.ContextMenuLayoutViewSet)
router.register(r'color-palette', ui.ColorPaletteViewSet)
