...
class PortalInterfaceAccessModel(AbstractClassModel):
    ...
    CLASSES = (
        ...
        (4, DATA_RESPONSIBLE, 'data_responsible', gettext_lazy("Data layer: Responsible")),
        (5, DATA_COUNTERPARTY, 'data_counterparty', gettext_lazy("Data layer: Counterparty")),
        ...
        (8, DATA_TRANSACTION, 'data_transaction', gettext_lazy("Data layer: Transaction")),
        (9, DATA_PRICE_HISTORY, 'data_price_history', gettext_lazy("Data layer: Price History")),
        (10, DATA_FX_HISTORY, 'data_fx_history', gettext_lazy("Data layer: FX History")),
        (11, DATA_SIMPLE_IMPORT, 'data_simple_import', gettext_lazy("Data layer: Simple Import")),
        (12, DATA_TRANSACTION_IMPORT, 'data_transaction_import', gettext_lazy("Data layer: Transaction Import")),
        (13, DATA_COMPLEX_IMPORT, 'data_complex_import', gettext_lazy("Data layer: Complex Import")),
        (14, DATA_INSTRUMENT_DOWNLOAD, 'data_instrument_download', gettext_lazy("Data layer: Instrument Download")),
        (15, DATA_PRICES_DOWNLOAD, 'data_prices_download', gettext_lazy("Data layer: Prices Download")),

        (1001, REPORT_BALANCE, 'report_balance', gettext_lazy("Reporting layer: Balance Report")),
        (1002, REPORT_PL, 'report_pl', gettext_lazy("Reporting layer: P&L Report")),
        (1003, REPORT_TRANSACTION, 'report_transaction', gettext_lazy("Reporting layer: Transaction Report")),
        (1004, REPORT_PERFORMANCE, 'report_performance', gettext_lazy("Reporting layer: Performance Report")),
        (1005, REPORT_CASH_FLOW, 'report_cash_flow', gettext_lazy("Reporting layer: Cash Flow Report")),
        (1006, REPORT_DASHBOARD, 'report_dashboard', gettext_lazy("Reporting layer: Dashboard")),
        (1007, REPORT_EVENT, 'report_event', gettext_lazy("Reporting layer: Event")),
        (1008, REPORT_BOOKMARK, 'report_bookmark', gettext_lazy("Reporting layer: Bookmark")),
        (1009, REPORT_INSTRUMENT_AUDIT, 'report_instrument_audit', gettext_lazy("Reporting layer: Instrument Audit")),
        (1010, REPORT_TRANSACTION_AUDIT, 'report_transaction_audit',
         gettext_lazy("Reporting layer: Transaction Audit")),
        (1011, REPORT_BASE_TRANSACTION, 'report_base_transaction', gettext_lazy("Reporting layer: Base Transaction")),
        (1012, REPORT_ACTIVITY_LOG, 'report_activity_log', gettext_lazy("Reporting layer: Activity Log")),
        ...
        (3001, SETTINGS_NOTIFICATION, 'settings_notification', gettext_lazy("Settings layer: Notification")),
        ...
        (3004, SETTINGS_EXPORT_MAPPING, 'settings_export_mapping', gettext_lazy("Settings layer: Export Mapping")),
        (3005, SETTINGS_IMPORT_MAPPING, 'settings_import_mapping', gettext_lazy("Settings layer: Import Mapping")),
        (3006, SETTINGS_PROVIDER, 'settings_provider', gettext_lazy("Settings layer: Provider")),
        ...
        (3010, SETTINGS_TIMEZONE, 'settings_timezone', gettext_lazy("Settings layer: Timezone")),
        (3011, SETTINGS_ECOSYSTEM_DEFAULT, 'settings_ecosystem_default',
         gettext_lazy("Settings layer: Ecosystem Default")),

        (4001, ACCOUNT_SETTINGS, 'account_settings', gettext_lazy("Account layer: Settings")),
        (4002, ACCOUNT_PERSONAL_DATA, 'account_personal_data', gettext_lazy("Account layer: Personal Data")),
...
class ColorPaletteColor(models.Model):
    ...
    name = models.CharField(max_length=255, default='', blank=True, verbose_name=gettext_lazy('name'))
    value = models.CharField(max_length=255, default='', blank=True, verbose_name=gettext_lazy('value'))
...
class EditLayout(BaseLayout, TimeStampedModel):
    member = models.ForeignKey(Member, related_name='edit_layouts', verbose_name=gettext_lazy('member'),
                               on_delete=models.CASCADE)
...
class Bookmark(BaseUIModel, MPTTModel):
    member = models.ForeignKey(Member, related_name='bookmarks', verbose_name=gettext_lazy('member'),
                               on_delete=models.CASCADE)
    ...
    uri = models.CharField(max_length=256, null=True, blank=True, verbose_name=gettext_lazy('uri'))
    list_layout = models.ForeignKey(ListLayout, null=True, blank=True, related_name='bookmarks',
                                    on_delete=models.SET_NULL, verbose_name=gettext_lazy('list layout'))
...
class Dashboard(models.Model):
    member = models.ForeignKey(Member, related_name='dashboards', verbose_name=gettext_lazy('member'),
                               on_delete=models.CASCADE)
