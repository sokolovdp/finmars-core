...
class RecycleBinViewSet(AbstractViewSet, ModelViewSet):
    ...
    def clear_bin(self, request, realm_code=None, space_code=None):
        ...
        celery_app.send_task('celery_tasks.bulk_delete', kwargs={"task_id": celery_task.id, "context": {"realm_code": celery_task.realm_code, "space_code": celery_task.space_code}},
