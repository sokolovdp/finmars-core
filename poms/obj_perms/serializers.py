...
class ModelWithObjectPermissionSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        self.save_object_permission(instance, group_object_permissions=group_object_permissions, created=True)
        return instance
    ...
    def update(self, instance, validated_data):
        ...
        self.save_object_permission(instance, group_object_permissions=group_object_permissions, created=False)
        return instance
