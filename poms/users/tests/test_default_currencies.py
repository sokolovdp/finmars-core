...
correct_mock_currencies_data = [
    ...
    {"user_code": "GBP", "name": "Pound Sterling (GBP)", "country_alpha_3": "GBR"},
]

not_correct_mock_currencies_data = [
    {"user_code": "CHF", "name": "Swiss Franc (CHF)", "country_alpha_3": "TT"},
    {"user_code": "GBP", "name": "Pound Sterling (GBP)", "country_alpha_3": ""},
]
