...
class FullDataCloner(object):
    ...
    def clone(self):
        _l.debug(
            "clone: master_user=%s, timezone=%s",
            self._source_master_user.pk,
            self._source_master_user.timezone,
        )
                ...
                try:
                    ...
                    try:
                        ...
                        value = field.remote_field.model.objects.get(
                            master_user=self._target_master_user, user_code=code
                        )
                        ...
                        try:
                            ...
                            value = field.remote_field.model.objects.get(
                                master_user=self._target_master_user, name=name
                            )
    ...
    def _integrations_2(self):
        ...
        self._simple_list_clone(
            ComplexTransactionImportSchemeField,
            "rule_scenario__scheme__master_user",
            "rule_scenario",
        ...
        self._simple_list_clone(
            ComplexTransactionImportSchemeReconField,
            "recon_scenario__scheme__master_user",
            "recon_scenario",
            "reference_name",
            "description",
            "value_string",
    ...
    def _transaction_types_1(self):
        ...
        self._simple_list_clone(
            TransactionTypeInputSettings,
            "transaction_type_input__transaction_type__master_user",
            "transaction_type_input",
            "linked_inputs_names",
        )
    ...
    def _transactions_1(self):
        ...
        self._simple_list_clone(
            ComplexTransactionInput,
            "complex_transaction__master_user",
            "complex_transaction",
            "transaction_type_input",
            "value_string",
            "value_float",
        ...
        for target_member in self._target_master_user.members.all():
            for source_member in self._source_master_user.members.all():
                if target_member.username == source_member.username:
                    self._simple_list_clone_member_specific(
                        ListLayout,
                        target_member,
                        source_member,
                        "member",
    ...
    def _complex_import_schemes_1(self):
        ...
        self._simple_list_clone(
            ComplexImportSchemeActionCsvImport,
            "complex_import_scheme__master_user",
    ...
    def _simple_list_clone_member_specific(
        self,
        model,
        target_member,
        source_member,
        *fields,
        ...
        _l.debug(
            "clone member %s specific %s: count=%s",
            source_member,
            model._meta.model_name,
            qs.count(),
        )
        for source in qs:
            self._simple_clone_member_specific(
                target_member,
                source_member,
                None,
                source,
    ...
    def _simple_clone_member_specific(
        self,
        target_member,
        source_member,
        target,
