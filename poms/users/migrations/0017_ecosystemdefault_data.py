...
def fix_ecosystem_default(apps, schema_editor):
    ...
    for master_user in MasterUser.objects.all():
        ...
        try:
            ...
            try:
                ecosystem_defaults.counterparty_group = CounterpartyGroup.objects.get(master_user=master_user,
                                                                                      user_code='-')
            ...
            try:
                ecosystem_defaults.responsible_group = ResponsibleGroup.objects.get(master_user=master_user,
                                                                                    user_code='-')
            ...
            try:
                ecosystem_defaults.strategy1_subgroup = Strategy1Subgroup.objects.get(master_user=master_user,
                                                                                      user_code='-')
            ...
            try:
                ecosystem_defaults.strategy2_subgroup = Strategy2Subgroup.objects.get(master_user=master_user,
                                                                                      user_code='-')
            ...
            try:
                ecosystem_defaults.strategy3_subgroup = Strategy3Subgroup.objects.get(master_user=master_user,
                                                                                      user_code='-')
            ...
            try:
                ecosystem_defaults.transaction_type_group = TransactionTypeGroup.objects.get(master_user=master_user,
                                                                                             user_code='-')
            ...
            try:
                ecosystem_defaults.transaction_type = TransactionType.objects.get(master_user=master_user,
                                                                                  user_code='-')
