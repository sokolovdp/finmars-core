...
class CeleryTask(TimeStampedModel):
    ...
    ttl = models.PositiveIntegerField(default=0, verbose_name=gettext_lazy('time to live'),
    ...
    def save(self, *args, **kwargs):
        ...
        if int(self.ttl) > 0 and not self.expiry_at:
            self.expiry_at = self.created + timedelta(seconds=float(self.ttl))
