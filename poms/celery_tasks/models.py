...
class CeleryTask(TimeStampedModel):
    ...
    Kinda legacy functionality (everything to background processes should be moved
    to Workflow/Olap microservices)
    ...
    Also we have poms.procedures, and poms.pricings and somehow it different entities
    but they do the same thing as CeleryTask
    Maybe in future procedures/pricing will be refactored and one day they will
    be just CeleryTask
    ...
    def update_progress(self, progress):
        ...
        _l.info(f"update_progress {progress}")
