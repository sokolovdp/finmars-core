...
#
#
# class CounterpartyGroupApiTestCase(
...
#         group = self.get_counterparty_group(
#             kwargs.get("group", "-"), self._a_master_user
#         )
#         data = super(CounterpartyApiTestCase, self)._make_new_data(
...
#
#
# class ResponsibleGroupApiTestCase(
#     BaseNamedModelTestCase, BaseApiWithPermissionTestCase
# ):
...
#
#     def _make_new_data(self, **kwargs):
#         group = self.get_responsible_group(
#             kwargs.get("group", "-"), self._a_master_user
#         )
#         data = super(ResponsibleApiTestCase, self)._make_new_data(
#             group=group.id, **kwargs
#         )
#         return data
