...
PACKAGE_RESPONSE_JSON = {
    ...
    "configuration_object": {
        ...
        "download_count": 0,
        "latest_release_object": {"id": 117, "version": "1.0.1", "changelog": ""},
        "is_package": True,
        "name": "Finmars Initial",
        "description": "",
    ...
    "manifest": {
        ...
        "actions": [{"workflow": "com.finmars.standard-workflow:init"}],
        "name": "Initial",
        "version": VERSION,
    },
    "version": VERSION,
...
EXPECTED_PROGRESS_OBJECT = {
    ...
    + len(PACKAGE_RESPONSE_JSON["manifest"]["actions"]),
...
MODULE_1_RESPONSE_JSON = {
    ...
    "configuration_object": {
        ...
        "download_count": 639,
        "latest_release_object": {"id": 23, "version": "1.0.0", "changelog": ""},
        "is_package": False,
...
MODULE_2_RESPONSE_JSON = {
    ...
    "configuration_object": {
        ...
        "download_count": 619,
        "latest_release_object": {"id": 17, "version": "1.0.0", "changelog": ""},
        "is_package": False,
