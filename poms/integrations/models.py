...
class ProviderClass(AbstractClassModel):
    BLOOMBERG = 1
    CLASSES = ((BLOOMBERG, "BLOOMBERG", gettext_lazy("Bloomberg")),)
...
class InstrumentDownloadScheme(NamedModel, DataTimeStampedModel, ConfigurationModel):
    ...
    instrument_user_code = models.CharField(
    ...
    instrument_short_name = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        blank=True,
        default="",
        verbose_name=gettext_lazy("short name"),
    )
    instrument_public_name = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        blank=True,
        default="",
        verbose_name=gettext_lazy("public name"),
    )
    instrument_notes = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        blank=True,
        default="",
    ...
    factor_schedule_method = models.ForeignKey(
    ...
    accrual_calculation_schedule_method = models.ForeignKey(
        AccrualScheduleDownloadMethod,
        null=True,
        blank=True,
        verbose_name=gettext_lazy("accrual calculation schedule method"),
        on_delete=models.SET_NULL,
    )
...
class InstrumentDownloadSchemeInput(models.Model):
    scheme = models.ForeignKey(
        ...
        related_name="inputs",
        verbose_name=gettext_lazy("scheme"),
        on_delete=models.CASCADE,
    )
    ...
    field = models.CharField(
        ...
        blank=True,
        default="",
        verbose_name=gettext_lazy("field"),
    )
    name_expr = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        blank=True,
        default="",
...
class InstrumentDownloadSchemeAttribute(models.Model):
    ...
    attribute_type = models.ForeignKey(
        ...
        null=True,
        blank=True,
        verbose_name=gettext_lazy("attribute_ type"),
        on_delete=models.SET_NULL,
    )
...
class PriceDownloadScheme(models.Model):
    ...
    scheme_name = models.CharField(
        max_length=255,
        verbose_name=gettext_lazy("scheme name"),
    )
    provider = models.ForeignKey(
        ProviderClass,
        verbose_name=gettext_lazy("provider"),
    ...
    bid0 = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("bid0"),
    )
    bid1 = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("bid1"),
    )
    bid2 = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("bid2"),
    )
    bid_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("bid multiplier"),
    )
    ask0 = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("ask0"),
    )
    ask1 = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("ask1"),
    )
    ask2 = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("ask2"),
    )
    ask_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("ask multiplier"),
    )
    last = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("last"),
    )
    last_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("last multiplier"),
    )
    mid = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("mid"),
    )
    mid_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("mid multiplier"),
    )
    bid_history = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("bid history"),
    )
    bid_history_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("bid history multiplier"),
    )
    ask_history = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("ask history"),
    )
    ask_history_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("ask history multiplier"),
    )
    mid_history = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("mid history"),
    )
    mid_history_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("mid history multiplier"),
    )
    last_history = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("last history"),
    )
    last_history_multiplier = models.FloatField(
        default=1.0,
        verbose_name=gettext_lazy("last history multiplier"),
    )
    currency_fxrate = models.CharField(
        max_length=50,
        blank=True,
        verbose_name=gettext_lazy("currency FX-rate"),
    )
    currency_fxrate_multiplier = models.FloatField(
        default=1.0,
...
class MappingTableKeyValue(models.Model):
    mapping_table = models.ForeignKey(
        MappingTable,
        verbose_name=gettext_lazy("mapping table"),
        on_delete=models.CASCADE,
        related_name="items",
...
class ComplexTransactionImportScheme(
    ...
    book_uniqueness_settings = models.PositiveSmallIntegerField(
        default=SKIP,
        choices=BOOK_UNIQUENESS_CHOICES,
    ...
    rule_expr = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        verbose_name=gettext_lazy("rule expressions"),
    )
    recon_layout_json = models.TextField(
        null=True,
        blank=True,
    ...
    missing_data_handler = models.CharField(
        max_length=255,
        choices=MISSING_DATA_CHOICES,
        default="throw_error",
    )
    spreadsheet_start_cell = models.CharField(
        max_length=255,
        default="A1",
    )
    spreadsheet_active_tab_name = models.CharField(
        max_length=255,
        default="",
        blank=True,
        null=True,
    ...
    has_header_row = models.BooleanField(
        default=True,
        verbose_name=gettext_lazy("has header row"),
    )
    data_preprocess_expression = models.CharField(
        null=True,
        max_length=EXPRESSION_FIELD_LENGTH,
        blank=True,
        default="",
...
class ComplexTransactionImportSchemeCalculatedInput(models.Model):
    scheme = models.ForeignKey(
        ComplexTransactionImportScheme,
        related_name="calculated_inputs",
        verbose_name=gettext_lazy("scheme"),
        on_delete=models.CASCADE,
    )
    name = models.CharField(max_length=255)
...
class ComplexTransactionImportSchemeRuleScenario(models.Model):
    ...
    selector_values = models.ManyToManyField(
...
class ComplexTransactionImportSchemeField(models.Model):
    ...
    rule_scenario = models.ForeignKey(
        ComplexTransactionImportSchemeRuleScenario,
        related_name="fields",
        null=True,
        verbose_name=gettext_lazy("rule scenario"),
        on_delete=models.CASCADE,
    )
    transaction_type_input = models.CharField(
        max_length=255,
...
class ComplexTransactionImportSchemeReconScenario(models.Model):
    ...
    line_reference_id = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        verbose_name=gettext_lazy("line reference id"),
    )
    reference_date = models.CharField(
        max_length=EXPRESSION_FIELD_LENGTH,
        verbose_name=gettext_lazy("reference_date"),
    )
    selector_values = models.ManyToManyField(
        "ComplexTransactionImportSchemeSelectorValue",
        blank=True,
...
class ComplexTransactionImportSchemeReconField(models.Model):
    recon_scenario = models.ForeignKey(
        ComplexTransactionImportSchemeReconScenario,
        related_name="fields",
        verbose_name=gettext_lazy("recon scenario"),
        on_delete=models.CASCADE,
    )
...
class TransactionFileResult(DataTimeStampedModel):
    ...
    file_path = models.TextField(
        blank=True,
        default="",
        verbose_name=gettext_lazy("File Path"),
    )
