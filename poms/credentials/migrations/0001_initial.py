        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(
                    choices=[(1, 'Username with password'), (2, 'SSH username with private key')], db_index=True,
                ...
                ('provider',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='integrations.DataProvider',
