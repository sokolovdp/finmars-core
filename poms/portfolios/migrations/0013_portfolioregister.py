    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_user_code', models.CharField(blank=True, max_length=25, null=True, verbose_name='deleted user code')),
                ('linked_instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='instruments.Instrument', verbose_name='linked instrument')),
                ('master_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='portfolio_registers', to='users.MasterUser', verbose_name='master user')),
                ('portfolio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portfolios.Portfolio', verbose_name='portfolio')),
                ('valuation_currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='currencies.Currency', verbose_name='valuation currency')),
                ('valuation_pricing_policy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='instruments.PricingPolicy', verbose_name='pricing policy')),
            ],
            options={
