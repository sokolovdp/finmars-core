    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='portfolio_bundles', related_query_name='bundle', to='portfolios.portfolioregister', verbose_name='registers')),
                ('master_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='portfolio_bundles', to='users.masteruser', verbose_name='master user')),
            ],
            options={
