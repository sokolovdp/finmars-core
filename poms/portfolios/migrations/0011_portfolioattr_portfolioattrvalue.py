...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('portfolios', '0010_auto_20160404_1323'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classifier_root', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='portfolios.PortfolioClassifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='portfolios.PortfolioAttr')),
                ('classifier', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='portfolios.PortfolioClassifier')),
