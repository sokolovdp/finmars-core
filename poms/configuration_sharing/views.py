...
class SharedConfigurationFileViewSet(AbstractModelViewSet):
    ...
    filter_backends = (
        AbstractModelViewSet.filter_backends
        + [
            # OwnerByUserFilter
        ]
    )
    ...
    def update(self, request, *args, **kwargs):
        ...
        if is_force:
            ...
            for layout in layouts:
                serializer = ConfigurationImportAsJsonSerializer(
                    data={
                        "data": instance.data,
                ...
                configuration_import_as_json.apply_async(
                    kwargs={
                        "instance": config_import_instance,
                        "context": {
