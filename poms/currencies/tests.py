...
from poms.common.tests import BaseApiWithTagsTestCase, BaseNamedModelTestCase
...
class CurrencyApiTestCase(BaseNamedModelTestCase, BaseApiWithTagsTestCase):
    ...
    def _create_obj(self, name='currency'):
        return self.create_currency(name, 'a')

    def _get_obj(self, name='currency'):
        return self.get_currency(name, 'a')
    ...
    def test_list_ordering(self):
        ...
        self._list_order('a', 'user_code', 4)
        self._list_order('a', 'name', 4)
        self._list_order('a', 'short_name', 4)
