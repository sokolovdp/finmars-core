...
class BalanceReportHistory(TimeStampedModel):
    master_user = models.ForeignKey(
        MasterUser,
        related_name="balance_report_histories",
...
class BalanceReportHistoryItem(models.Model):
    balance_report_history = models.ForeignKey(
...
class PLReportHistoryItem(models.Model):
    pl_report_history = models.ForeignKey(
        PLReportHistory,
        related_name="items",
        verbose_name=gettext_lazy("pl report history"),
        on_delete=models.CASCADE,
    )
