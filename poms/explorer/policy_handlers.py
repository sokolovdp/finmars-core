...
#     Parameters:
#         obj (StorageObject): The object to create the policy for.
...
#         obj = StorageObject.objects.get(path=path, is_file=False)
#     else:
#         obj = StorageObject.objects.get(path=path, is_file=True)
#
