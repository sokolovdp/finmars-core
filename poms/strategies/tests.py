...
#
#
# class BaseStrategyGroupApiTestCase(
...
#
#
# class BaseStrategySubgroupApiTestCase(
#     BaseNamedModelTestCase, BaseApiWithPermissionTestCase
# ):
#     model = None
#     strategy_code = None
...
#         return self.create_strategy_subgroup(
#             self.strategy_code, name, self._a_master_user
#         )
#
...
#         group = self.get_strategy_group(
#             self.strategy_code, kwargs.get("group", "-"), self._a_master_user
#         )
#         data = super(BaseStrategySubgroupApiTestCase, self)._make_new_data(
...
#
#     def _make_new_data(self, **kwargs):
#         subgroup = self.get_strategy_subgroup(
#             self.strategy_code, kwargs.get("subgroup", "-"), self._a_master_user
#         )
#         data = super(BaseStrategyApiTestCase, self)._make_new_data(
#             subgroup=subgroup.id, **kwargs
#         )
#         return data
#
#
