    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_handler', models.PositiveSmallIntegerField(
                    choices=[(1, 'Skip'), (2, 'Default Price'), (3, 'Ask For Manual Entry'), (4, 'Add to Pricing Log')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_type', models.PositiveSmallIntegerField(
                    choices=[(1, 'None'), (2, 'Single Parameter'), (3, 'Multiple Parameters')], default=1,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                    to='pricing.InstrumentPricingSchemeType', verbose_name='type'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                    to='pricing.CurrencyPricingSchemeType', verbose_name='type'),
        ),
