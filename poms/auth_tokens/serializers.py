...
class CreatePersonalAccessTokenSerializer(serializers.ModelSerializer):
    ...
    days_to_live = serializers.IntegerField(write_only=True, initial=90, min_value=1, max_value=365, help_text="Number of days until the token expires. Up to 365 days.")
