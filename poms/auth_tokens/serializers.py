...
class CreateUserSerializer(serializers.Serializer):
    ...
    roles = serializers.CharField(label=_("Roles"), required=False, allow_blank=True)
    groups = serializers.CharField(label=_("Groups"), required=False, allow_blank=True)

    is_admin = serializers.BooleanField(label=_("Is Admin"), required=False)
