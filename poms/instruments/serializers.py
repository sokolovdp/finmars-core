...
class InstrumentSerializer(ModelWithAttributesSerializer, ModelWithObjectPermissionSerializer,
    ...
    pricing_currency_object = ReadonlyNamedModelWithObjectPermissionSerializer(source='instrument_type')
    accrued_currency = CurrencyField(default=CurrencyDefault())
    accrued_currency_object = ReadonlyNamedModelWithObjectPermissionSerializer(source='instrument_type')
