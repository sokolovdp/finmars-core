...
#         accrued_currency = accrued_currency or self.get_currency(
#             "USD", self._a_master_user
#         )
#
#         return self.create_instrument_type(
#             name, self._a_master_user, accrued_currency=accrued_currency
#         )
#
...
#         kwargs["instrument_class"] = kwargs.get(
...
#         pricing_currency = pricing_currency or self.get_currency(
#             "USD", self._a_master_user
#         )
#         accrued_currency = accrued_currency or self.get_currency(
#             "USD", self._a_master_user
...
#             kwargs.get("instrument_type", "-"), self._a_master_user
#         )
#         kwargs["instrument_type"] = instrument_type.id
#         pricing_currency = self.get_currency(
#             kwargs.get("pricing_currency", "USD"), self._a_master_user
#         )
#         kwargs["pricing_currency"] = pricing_currency.id
#         accrued_currency = self.get_currency(
#             kwargs.get("accrued_currency", "USD"), self._a_master_user
#         )
