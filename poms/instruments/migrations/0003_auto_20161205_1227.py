...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='account',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='generated_events', to='accounts.Account'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='action',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='generated_events', to='instruments.EventScheduleAction'),
        ),
        migrations.AddField(
            model_name='generatedevent',
        ...
        migrations.AddField(
            model_name='generatedevent',
            name='event_schedule',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='generated_events', to='instruments.EventSchedule'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='instrument',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='generated_events', to='instruments.Instrument'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='master_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='generated_events', to='users.MasterUser'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='member',
        ...
        migrations.AddField(
            model_name='generatedevent',
            name='portfolio',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='generated_events', to='portfolios.Portfolio'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='strategy1',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='generated_events', to='strategies.Strategy1'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='strategy2',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='generated_events', to='strategies.Strategy2'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='strategy3',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='generated_events', to='strategies.Strategy3'),
        ),
        migrations.AddField(
            model_name='generatedevent',
            name='transaction_type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='generated_events', to='transactions.TransactionType'),
        ),
        migrations.AddField(
