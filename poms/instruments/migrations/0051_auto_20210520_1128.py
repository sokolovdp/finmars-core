...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.PositiveSmallIntegerField(choices=[(1, 'Direct Position'), (2, 'Factor Adjusted Position'), (3, 'Do not show')], default=1, verbose_name='position reporting'),
        ),
        migrations.AddField(
            model_name='instrumenttype',
            name='co_directional_exposure_currency',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='co directional exposure currency'),
        ),
        migrations.AddField(
            model_name='instrumenttype',
            name='counter_directional_exposure_currency',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='counter directional exposure currency'),
        ),
        migrations.AddField(
            model_name='instrumenttype',
