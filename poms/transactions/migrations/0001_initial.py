    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'Production'), (2, 'Pending')], db_index=True, default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('overheads', models.FloatField(default=0.0, help_text='Absolute value of Carry with Sign (for calculations on the form)', verbose_name='overheads')),
                ('account_cash', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_account_cash', to='accounts.Account', verbose_name='account cash')),
                ('account_interim', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_account_interim', to='accounts.Account', verbose_name='account interim')),
                ('account_position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_account_position', to='accounts.Account', verbose_name='account position')),
                ('allocation_balance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_allocation_balance', to='instruments.Instrument', verbose_name='allocation balance')),
                ('allocation_pl', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_allocation_pl', to='instruments.Instrument', verbose_name='allocation P&L')),
                ('complex_transaction', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transactions', to='transactions.ComplexTransaction')),
                ('counterparty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='counterparties.Counterparty', verbose_name='counterparty')),
                ('instrument', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='instruments.Instrument', verbose_name='instrument')),
                ('linked_instrument', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_linked', to='instruments.Instrument', verbose_name='linked instrument')),
                ...
                ('responsible', models.ForeignKey(blank=True, help_text='Trader or transaction executor', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions', to='counterparties.Responsible', verbose_name='responsible')),
                ('settlement_currency', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='transactions_settlement_currency', to='currencies.Currency', verbose_name='settlement currency')),
                ('strategy1_cash', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_strategy1_cash', to='strategies.Strategy1', verbose_name='strategy - 1 - position')),
                ('strategy1_position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_strategy1_position', to='strategies.Strategy1', verbose_name='strategy - 1 - cash')),
                ('strategy2_cash', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_strategy2_cash', to='strategies.Strategy2', verbose_name='strategy - 2 - position')),
                ('strategy2_position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_strategy2_position', to='strategies.Strategy2', verbose_name='strategy - 2 - cash')),
                ('strategy3_cash', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_strategy3_cash', to='strategies.Strategy3', verbose_name='strategy - 3 - position')),
                ('strategy3_position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_strategy3_position', to='strategies.Strategy3', verbose_name='strategy - 3 - cash')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='accounts.Account')),
                ...
                ('counterparty', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='counterparties.Counterparty')),
                ('currency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='currencies.Currency')),
                ...
                ('portfolio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='portfolios.Portfolio')),
                ('price_download_scheme', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='integrations.PriceDownloadScheme')),
                ('responsible', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='counterparties.Responsible')),
                ('strategy1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='strategies.Strategy1')),
                ('strategy2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='strategies.Strategy2')),
                ('strategy3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='strategies.Strategy3')),
