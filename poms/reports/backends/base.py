...
class BaseReport2Builder(object):
    def __init__(self, instance=None, queryset=None, transactions=None):
        ...
        self._use_strategy1 = self.instance.use_strategy1
        self._use_strategy2 = self.instance.use_strategy2
        self._use_strategy3 = self.instance.use_strategy3
    ...
    def make_key(self, portfolio=None, account=None, instrument=None, currency=None, ext=None,
        ...
        strategy1 = getattr(strategy1, 'pk', None) if self._use_strategy1 else ''
        strategy2 = getattr(strategy2, 'pk', None) if self._use_strategy2 else ''
        strategy3 = getattr(strategy3, 'pk', None) if self._use_strategy3 else ''
    ...
    def make_item(self, item_cls, key, portfolio=None, account=None, strategy1=None, strategy2=None, strategy3=None,
        ...
        item = item_cls(pk=key,
                        ...
                        strategy1=strategy1 if self._use_strategy1 else None,
                        strategy2=strategy2 if self._use_strategy2 else None,
                        strategy3=strategy3 if self._use_strategy3 else None,
                        **kwargs)
        return item

    def to_system_ccy(self, value, ccy):
        history = self.find_currency_history(ccy)
