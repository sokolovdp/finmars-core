...
from poms.reports.backend_reports_utils import almost_equal_floats, BackendReportHelperService
...
class TestAlmostEqualFloats(TestCase):
    ...
    def test_equal_up_to_n_decimals(self):
        self.assertTrue(almost_equal_floats(1.234567, 1.234599))  # Equal up to 4 decimals
        self.assertFalse(almost_equal_floats(1.234567, 1.235599))  # Different at 3rd decimal
    ...
    def test_large_numbers(self):
        ...
        self.assertTrue(almost_equal_floats(123456.12343, 123456.12346))  # Equal up to 4 decimals
    ...
    def test_edge_cases(self):
        self.assertFalse(almost_equal_floats(float("nan"), float("nan")))  # NaN is not equal to itself
        self.assertTrue(almost_equal_floats(1.000049, 1.000051, round_digits=4))  # Very close

    def test_custom_round_digits(self):
        self.assertTrue(almost_equal_floats(1.234567, 1.234568, round_digits=5))  # Equal up to 5 decimals
        self.assertFalse(almost_equal_floats(1.234567, 1.234577, round_digits=5))  # Different at 5th decimal
