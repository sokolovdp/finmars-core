    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_instance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='schedules.ScheduleInstance', verbose_name='schedule instance')),
            ],
            options={
                'ordering': ['-created'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_from_expr', models.CharField(blank=True, default='', max_length=1024, null=True, verbose_name='price date from expr')),
                ('date_to', models.DateField(blank=True, null=True, verbose_name='price date to')),
                ('date_to_expr', models.CharField(blank=True, default='', max_length=1024, null=True, verbose_name='price date to expr')),
