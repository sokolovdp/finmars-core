        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.PositiveSmallIntegerField(
                    choices=[(1, 'Created by User'), (2, 'Created by Instrument'), (3, 'Created by Currency')],
                    default=1, verbose_name='type')),
                ('price_date_from', models.DateField(blank=True, null=True, verbose_name='price date from')),
                ('price_date_from_expr', models.CharField(blank=True, default='', max_length=1024, null=True,
                                                          verbose_name='price date from expr')),
                ('price_date_to', models.DateField(blank=True, null=True, verbose_name='price date to')),
                ('price_date_to_expr', models.CharField(blank=True, default='', max_length=1024, null=True,
                ...
                ('price_get_principal_prices',
                 models.BooleanField(default=False, verbose_name='price get principal prices')),
                ('price_get_accrued_prices',
                 models.BooleanField(default=False, verbose_name='price get accrued prices')),
                ('price_get_fx_rates', models.BooleanField(default=False, verbose_name='price get fx rates')),
                ('price_overwrite_principal_prices',
                 models.BooleanField(default=False, verbose_name='price overwrite principal prices')),
                ('price_overwrite_accrued_prices',
                 models.BooleanField(default=False, verbose_name='price overwrite accrued prices')),
                ('price_overwrite_fx_rates',
                 models.BooleanField(default=False, verbose_name='price overwrite fx rates')),
                ('pricing_policy_filters',
                 models.TextField(blank=True, default='', verbose_name='pricing policy filters')),
                ...
                ('instrument_type_filters',
                 models.TextField(blank=True, default='', verbose_name='instrument type filters')),
                ('instrument_pricing_scheme_filters',
                 models.TextField(blank=True, default='', verbose_name='instrument pricing scheme filters')),
                ('instrument_pricing_condition_filters',
                 models.TextField(blank=True, default='', verbose_name='instrument pricing condition filters')),
                ('currency_pricing_scheme_filters',
                 models.TextField(blank=True, default='', verbose_name='currency pricing scheme filters')),
                ('currency_pricing_condition_filters',
                 models.TextField(blank=True, default='', verbose_name='currency pricing condition filters')),
                ('master_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.MasterUser',
                                                  verbose_name='master user')),
            ],
            options={
            ...
            fields=[
                ...
                ('parent_procedure_instance',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='procedures', to='procedures.PricingParentProcedureInstance',
                                   verbose_name='parent pricing procedure')),
                ('pricing_procedure',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='procedures.PricingProcedure',
                                   verbose_name='pricing procedure')),
            ],
        ),
        migrations.AddField(
            model_name='pricingparentprocedureinstance',
            name='pricing_procedure',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='procedures.PricingProcedure',
                                    verbose_name='pricing procedure'),
        ),
    ]
