...
class PackageSettings:
    ...
    setting_name = "FINMARS_STANDARDIZED_ERRORS"
...
DEFAULTS: Dict = {
    "EXCEPTION_HANDLER_CLASS": "finmars_standardized_errors.handler.ExceptionHandler",
    "EXCEPTION_FORMATTER_CLASS": "finmars_standardized_errors.formatter.ExceptionFormatter",
